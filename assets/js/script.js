...
function removeFromPlaylist(button, playlistId){
	...
	$.post("includes/handlers/ajax/removeFromPlaylist.php", {playlistId: playlistId, songId:songId}).done((error)=>{
...
function deletePlaylist(playlistId){
	...
	if(prompt==true){
		$.post("includes/handlers/ajax/deletePlaylist.php", {playlistId: playlistId}).done((error)=>{
